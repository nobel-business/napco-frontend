        ...
        <Container data-reveal-stagger className="space-y-10">
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {systems.map((item) => (
              <article
                key={item.title}
                className="hover-lift group fx-glow-orange fx-glow-text-orange flex flex-col items-center gap-4 rounded-2xl border border-border bg-surface p-8 text-center shadow-card"
              >

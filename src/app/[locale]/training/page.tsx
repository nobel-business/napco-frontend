  ...
  return (
    <>
      ...
      <section className="section">
        <Container>
          <div className="fx-glow-text-teal grid items-center gap-10 rounded-3xl bg-surface-tint p-6 shadow-card md:p-10 lg:grid-cols-[1.5fr_1fr] dark:bg-surface">
        ...
        <Container data-reveal-stagger className="space-y-10">
          ...
          <div className="grid gap-6 lg:grid-cols-3">
            {tracks.map((track) => (
              <article
                key={track.title}
                className="hover-lift group fx-glow-teal fx-glow-text-teal space-y-4 rounded-2xl border border-border bg-surface p-6 shadow-card"
              >
      ...
      {/* PROGRAMS IN DETAIL */}
      <section className="section">
        <Container data-reveal-stagger className="space-y-10 lg:space-y-16">
        ...
        <Container data-reveal-stagger className="space-y-10">
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {steps.map((step, i) => (
              <article
                key={step.title}
                className="hover-lift fx-glow-teal fx-glow-text-teal space-y-4 rounded-2xl border border-border bg-surface p-6 shadow-card"
              >
            ...
            {cards.map((card) => (
              <article
                ...
                className={cn(
                  ...
                  card.variant === "blue"
                    ? "bg-gradient-navy fx-glow-teal fx-glow-text-teal"
                    : "bg-gradient-card-orange fx-glow-orange fx-glow-text-orange",
                )}
              >

...
const ar: { categories: Category[]; articles: ArticleData[] } = {
  ...
  articles: [
    { slug: "fish-farm-layout-planning", categoryKey: "smart-design", category: "التصميم الذكي", title: "الدليل الكامل لتخطيط تصميم المزارع السمكية", excerpt: "تعرّف على أساسيات تصميم مزرعة سمكية فعّالة، من توزيع الأحواض إلى تحسين تدفق المياه.", date: "٢٠ يناير ٢٠٢٥", image: images[0] },
    { slug: "water-quality-management", categoryKey: "operations", category: "التشغيل", title: "إدارة جودة المياه: المعايير الأساسية", excerpt: "أتقن معايير جودة المياه الحرجة التي تضمن نمواً صحياً للأسماك وإنتاجية مثلى للمزرعة.", date: "٢٠ يناير ٢٠٢٥", image: images[1] },
    { slug: "feeding-strategies-growth", categoryKey: "nutrition", category: "التغذية", title: "استراتيجيات التغذية لتحقيق أقصى معدل نمو", excerpt: "اكتشف تقنيات التغذية المثبتة وخطط التغذية التي تعظّم نمو الأسماك مع تقليل التكاليف.", date: "٢٠ يناير ٢٠٢٥", image: images[2] },
    { slug: "modern-filtration-systems", categoryKey: "modern-tech", category: "التقنيات الحديثة", title: "فهم أنظمة الترشيح الحديثة", excerpt: "كيف تحافظ أنظمة الترشيح المتقدمة على نظافة المياه وصحة الأسماك وكفاءة التشغيل عبر دورة الإنتاج.", date: "١٨ يناير ٢٠٢٥", image: images[3] },
    { slug: "biosecurity-best-practices", categoryKey: "quality-safety", category: "الجودة والسلامة", title: "أفضل ممارسات الأمن الحيوي للمزارع السمكية", excerpt: "احمِ إنتاجك بخطة أمن حيوي متعددة الطبقات تقلل المخاطر وتمنع تفشي الأمراض.", date: "١٥ يناير ٢٠٢٥", image: images[4] },
    { slug: "ras-vs-biofloc", categoryKey: "smart-design", category: "التصميم الذكي", title: "RAS مقابل البايوفلوك: اختيار النظام الأنسب", excerpt: "مقارنة عملية بين الأنظمة المغلقة وأنظمة البايوفلوك لمساعدتك على اختيار الأنسب لمشروعك.", date: "١٢ يناير ٢٠٢٥", image: images[5] },
    { slug: "disease-prevention", categoryKey: "quality-safety", category: "الجودة والسلامة", title: "الوقاية من أمراض الأسماك والكشف المبكر", excerpt: "تعرّف على العلامات المبكرة وطبّق أفضل الممارسات البيطرية للحفاظ على صحة مخزونك طوال العام.", date: "١٠ يناير ٢٠٢٥", image: images[6] },
    { slug: "iot-monitoring", categoryKey: "modern-tech", category: "التقنيات الحديثة", title: "مراقبة إنترنت الأشياء للاستزراع المائي الدقيق", excerpt: "استخدم المستشعرات والأتمتة والبيانات اللحظية لتحسين التغذية وجودة المياه وكفاءة التشغيل.", date: "٨ يناير ٢٠٢٥", image: images[7] },
    { slug: "cost-optimization", categoryKey: "operations", category: "التشغيل", title: "تحسين التكاليف في الاستزراع السمكي التجاري", excerpt: "قلّل هدر الأعلاف واستهلاك الطاقة والتكاليف التشغيلية مع زيادة العائد على الاستثمار.", date: "٥ يناير ٢٠٢٥", image: images[8] },
  ],
};

...
const en: { categories: Category[]; articles: ArticleData[] } = {
  ...
  articles: [
    ...
    { slug: "water-quality-management", categoryKey: "operations", category: "Operations", title: "Water Quality Management Essential Parameters", excerpt: "Master the critical water quality parameters that ensure healthy fish growth and optimal farm productivity.", date: "Jan 20, 2025", image: images[3] },
    ...
    { slug: "modern-filtration-systems", categoryKey: "modern-tech", category: "Modern Technologies", title: "Understanding Modern Filtration Systems", excerpt: "How advanced filtration keeps water clean, fish healthy and operations efficient across the production cycle.", date: "Jan 18, 2025", image: images[1] },
    ...
    { slug: "iot-monitoring", categoryKey: "modern-tech", category: "Modern Technologies", title: "IoT Monitoring for Precision Aquaculture", excerpt: "Use sensors, automation and real-time data to optimize feeding, water quality and operational efficiency.", date: "Jan 8, 2025", image: images[0] },
    { slug: "cost-optimization", categoryKey: "operations", category: "Operations", title: "Cost Optimization in Commercial Fish Farming", excerpt: "Reduce feed waste, energy use and operational overhead while increasing your return on investment.", date: "Jan 5, 2025", image: images[1] },
  ],
};
...
const ar: { categories: Category[]; articles: ArticleData[] } = {
  ...
  articles: [
    ...
    { slug: "water-quality-management", categoryKey: "operations", category: "التشغيل", title: "إدارة جودة المياه: المعايير الأساسية", excerpt: "أتقن معايير جودة المياه الحرجة التي تضمن نمواً صحياً للأسماك وإنتاجية مثلى للمزرعة.", date: "20 يناير 2025", image: images[3] },
    ...
    { slug: "modern-filtration-systems", categoryKey: "modern-tech", category: "التقنيات الحديثة", title: "فهم أنظمة الترشيح الحديثة", excerpt: "كيف تحافظ أنظمة الترشيح المتقدمة على نظافة المياه وصحة الأسماك وكفاءة التشغيل عبر دورة الإنتاج.", date: "18 يناير 2025", image: images[1] },
    ...
    { slug: "iot-monitoring", categoryKey: "modern-tech", category: "التقنيات الحديثة", title: "مراقبة إنترنت الأشياء للاستزراع المائي الدقيق", excerpt: "استخدم المستشعرات والأتمتة والبيانات اللحظية لتحسين التغذية وجودة المياه وكفاءة التشغيل.", date: "8 يناير 2025", image: images[0] },
    { slug: "cost-optimization", categoryKey: "operations", category: "التشغيل", title: "تحسين التكاليف في الاستزراع السمكي التجاري", excerpt: "قلّل هدر الأعلاف واستهلاك الطاقة والتكاليف التشغيلية مع زيادة العائد على الاستثمار.", date: "5 يناير 2025", image: images[1] },
  ],
};
